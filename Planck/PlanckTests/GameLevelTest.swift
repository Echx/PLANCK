...
class GameLevelTest: XCTestCase {
    func testComparableAndEquatable() {
        ...
        XCTAssertEqual(game1 < game3, false, "Comparable not implemented correctly")
    }
    ...
    func testGetNextLevel() {
        ...
        XCTAssertEqual(game.indexForNextLevel, 51, "Equatable not implemented correctly")
    }
    ...
    func testDeepcopy() {
        ...
        XCTAssertEqual(copy.index, 20, "Equatable not implemented correctly")
        
        XCTAssertNotEqual(game.index, copy.index, "Equatable not implemented correctly")
    }
