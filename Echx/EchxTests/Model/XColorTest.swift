...
class XColorTest: XCTestCase {
    ...
    func testBlue() {
        ...
        let blueColor2 = XColor(containsRed: true, containsGreen: true, containsBlue: true)
        
        let resultedColor = blueColor1 + blueColor2
        
        println("result: red:\(resultedColor.containsRed) green:\(resultedColor.containsGreen) blue:\(resultedColor.containsBlue)")
        println("Blue: red:\(blueColor2.containsRed) green:\(blueColor2.containsGreen) blue:\(blueColor2.containsBlue)")
        
        XCTAssertTrue(resultedColor == pureBlue, "Red + Red should be red!")
